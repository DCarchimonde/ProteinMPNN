...
def featurize_inference_complex(b, device):
    ...
    all_chains = masked_list + visible_list # 确保解析所有链
...
def generate_sequences(model, features, num_seqs=100, temperature=0.2, methyl_threshold=0.30):
...
def main():
    ...
    parser.add_argument("--methyl_threshold", type=float, default=0.30) # 使用我们测出来的最佳阈值
