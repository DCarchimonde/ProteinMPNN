...
import torch.utils.checkpoint # <--- [修复] 显式导入 checkpoint 模块
import json
import numpy as np
import random
...
try:
    # 确保 model_utils.py 是我为您提供的那个新版本
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./final_run_v7")
    ...
    if 'W_s.weight' in state_dict:
        ...
        ws = state_dict['module.W_s.weight']
    else:
        ws = None
